...
CREATE TABLE drink_shop_level_config
(
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    level TINYINT NOT NULL,
    required_island_level TINYINT NOT NULL,
    renovation_gold BIGINT NOT NULL,
    queue_capacity TINYINT NOT NULL,
    bar_capacity TINYINT NOT NULL,
    sale_interval_seconds INT NOT NULL,
    arrival_interval_seconds INT NOT NULL,
    ice_cream_enabled TINYINT NOT NULL DEFAULT 0,
    advanced_recipe_enabled TINYINT NOT NULL DEFAULT 0,
...
CREATE TABLE player_drink_shop
(
    id BIGINT PRIMARY KEY AUTO_INCREMENT,
    player_id BIGINT NOT NULL,
...
CREATE TABLE satisfaction_gift_config (
...
CREATE TABLE daily_satisfaction (
...
(
    ...
    max_flower_level INT NOT NULL DEFAULT 10,
    enabled TINYINT NOT NULL DEFAULT 1,
    create_time DATETIME DEFAULT CURRENT_TIMESTAMP,
    update_time DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP
) COMMENT = '花卉基础配置表';
